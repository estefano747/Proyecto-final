...
function Creadores() {
    const [listaCreadores, setListaCreadores] = useState([])
                ...
                <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h3 className="modal-title fs-5" id="exampleModalLabel">Nuevo Creador</h3>
                            <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <form onSubmit={(event) => insertCreador(event)}>
                            <div className="modal-body">
                                ...
                                <div className="mb-3">
                                    <input type="text" className="form-control" placeholder="Creaciones"
        ...
        return (
            <div className="modal fade" id="updateModal" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h3 className="modal-title fs-5" id="exampleModalLabel">Actualizar Creador</h3>
                            <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <form onSubmit={(event) => updateCreador(event)}>
                            <div className="modal-body">
                                <div className="mb-3">
        ...
        return (
            <div className="modal fade" id="deleteModal" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h3 className="modal-title fs-5" id="exampleModalLabel">Eliminar Creador</h3>
                            <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <form onSubmit={(event) => deleteCreador(event)}>
                            <div className="modal-body">
                                ¿Está seguro que desea eliminar al creador <strong>{nombres}</strong>?
                            </div>
                            <div className="modal-footer">
                                <button type="button" className="btn btn-secondary" data-bs-dismiss="modal">Cerrar</button>
    ...
    const updateCreador = (event) => {
        ...
        let formData = new FormData()
        formData.append("iddirector", idcreador)
        formData.append("nombres", nombres)
        formData.append("peliculas", peliculas)
    ...
    return (
        <section id='creadores' className='padded'>
            <div className="container">
                <h2>Creadores</h2>
                <div className="mb-3">
                    <button className="btn btn-primary"
                        data-bs-toggle="modal" data-bs-target="#insertModal">Nuevo Creador</button>
                </div>
                {dibujarTabla()}
                {dibujarInsertModal()}
                {dibujarUpdateModal()}
